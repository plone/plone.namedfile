...
class TestEquality(unittest.TestCase):
    ...
    def test_named_image_inequality_filename(self):
        image1 = NamedImage(data=zptlogo, contentType="image/gif", filename="logo.gif")
        image2 = NamedImage(data=zptlogo, contentType="image/gif", filename="other.gif")
        self.assertNotEqual(image1, image2)

    def test_named_image_inequality_content_type(self):
        image1 = NamedImage(data=zptlogo, contentType="image/gif", filename="logo.gif")
        image2 = NamedImage(data=zptlogo, contentType="image/png", filename="logo.gif")
        self.assertNotEqual(image1, image2)
